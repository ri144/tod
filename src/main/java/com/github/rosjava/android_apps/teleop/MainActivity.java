...
*/
    ...
    private void update() {
            double number = Double.parseDouble(linex.getText().toString()) * (100.0)+x;  //distance of 12 m, -3 to 9
            double number2 = Double.parseDouble(liney.getText().toString()) * (-100.0)+ y;  //distance of 9.5, -4.5 to  5
            Float numberf = (float) number;
            Float number2f = (float) number2;
            /*if(numberf <0 || numberf > 1200 || number2f < 0 || number2f>1000){
                makeSmaller();
            }*/
            arrayX.add(numberf);
            arrayY.add(number2f);
    ...
    private void redraw() {
        ...
        while (a != 0) {
            pic.paintSomething((arrayX.get(arrayX.size() - a)), arrayY.get(arrayY.size() - a));
            a -= 1;
        }
    }
    ...
    @Override
	  ...
	  public boolean onOptionsItemSelected(MenuItem item){
          ...
          try {
              ...
              Intent intent = new Intent(MainActivity.this, com.github.rosjava.android_apps.teleop.Odometry.class);
          ...
          //case 2:
            //  Intent intent = new Intent(MainActivity.this, com.github.rosjava.android_apps.teleop.Test.class);
              //startActivity(intent);
          case 3:
              Intent intent3 =new Intent(MainActivity.this, com.github.rosjava.android_apps.teleop.DrawingView.class);
